...
#ifndef BBOTPAUTHENTICATORDELEGATE_CLASS
#define BBOTPAUTHENTICATORDELEGATE_CLASS

NS_ASSUME_NONNULL_BEGIN

/// Conforming objects will be notified about events of the OTP flow
@protocol BBOTPAuthenticatorDelegate <BBAuthenticatorDelegate>
 ...
 */
- (void)OTPDidSelectChoice:(BBOTPChoice*)choice NS_SWIFT_NAME(otpDidSelect(choice:));
