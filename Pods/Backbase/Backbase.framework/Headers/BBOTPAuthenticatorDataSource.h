//
//  BBOTPAuthenticatorDataSource.h
//  Backbase
//
...
#ifndef BBOTPAUTHENTICATORDATASOURCE_PROTOCOL
#define BBOTPAUTHENTICATORDATASOURCE_PROTOCOL

NS_ASSUME_NONNULL_BEGIN

/// Conforming objects will provide data related to the OTP challenges
@protocol BBOTPAuthenticatorDataSource <BBAuthenticatorDataSource>
...
- (NSArray<BBOTPChoice*>* _Nullable)OTPAuthenticatorAvailableMethods;
